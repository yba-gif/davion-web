...
useSeoMeta({ title: 'Manufacturing', description: 'Sovereign AI for manufacturers — asset health, supply-chain visibility, anomaly response, and quality at scale.' })
</script>

<template>
    <div class="flex flex-col gap-4">
        <section class="bg-white rounded-3xl px-6 md:px-12 lg:px-16 py-20 md:py-28">
            <CommonSup title="Industries · Manufacturing" />
            <h1 class="font-degular font-bold text-drygray-100 mt-6 text-[44px] leading-[1.05] md:text-[60px] md:leading-[0.98] lg:text-[80px] tracking-tight max-w-4xl">
                Fleet-wide intelligence. Operator-grade response<span class="text-primary">.</span>
            </h1>
            <p class="text-b2 text-drygray-default mt-8 max-w-3xl">
                Davion deploys sovereign AI for asset health, supply-chain visibility, anomaly response, and quality at scale — across distributed plants and partners, without telemetry leaving the perimeter.
            </p>
        ...
        <section class="bg-azure rounded-3xl px-6 md:px-12 lg:px-16 py-16 md:py-20">
            ...
            <p class="text-b2 text-drygray-default mt-6 max-w-3xl">
                Manufacturing deployments run on AlpOS — the sovereign AI platform. Ingest, ontology, analytics, AI, decisioning, action — governed end to end across asset, supplier, and operator boundaries.
            </p>
            <div class="mt-8">
