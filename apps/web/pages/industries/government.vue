...
useSeoMeta({ title: 'Government', description: 'Sovereign AI for the public sector — cross-agency integration, citizen-data law respected by design, decisioning at population scale.' })
</script>
