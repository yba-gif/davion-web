...
useSeoMeta({
    ...
    ogTitle: () => t('pages.legal.privacy.meta.ogTitle'),
    ogDescription: () => t('pages.legal.privacy.meta.ogDescription'),
})
            ...
            <ol class="space-y-8 max-w-4xl">
                <li v-for="s in sections" :key="s.n" class="grid md:grid-cols-12 gap-4 md:gap-8 border-t border-drygray-200 pt-8 first:border-t-0 first:pt-0">
                    <div class="md:col-span-3">
                        ...
                        <p class="text-h3 font-degular font-bold text-drygray-100 mt-2 leading-tight">{{ $t(`pages.legal.privacy.${s.t}`) }}</p>
                    </div>
                    <div class="md:col-span-9">
                        <p class="text-b1 text-drygray-100 leading-relaxed">{{ $t(`pages.legal.privacy.${s.b}`) }}</p>
                    </div>
                </li>
            </ol>
        </section>
