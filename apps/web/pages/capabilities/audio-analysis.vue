...
<template>
    <div class="flex flex-col gap-4">
        <section class="bg-white rounded-3xl px-6 md:px-12 lg:px-16 py-20 md:py-28">
            <CommonSup title="Capability · Audio" />
            <h1 class="font-degular font-bold text-drygray-100 mt-6 text-[44px] leading-[1.05] md:text-[60px] md:leading-[0.98] lg:text-[68px] tracking-tight max-w-5xl">
                Listen at scale<span class="text-primary-text">.</span> Audit at the same scale<span class="text-primary-text">.</span>
            </h1>
            <p class="text-b2 text-drygray-default mt-8 max-w-3xl">
                AlpOS Audio Analysis transcribes, diarises, and extracts structure from calls, interviews, and broadcasts. Speaker identification, sentiment shifts, topic boundaries, and compliance-relevant events become first-class signals in the ontology.
            </p>
        ...
        <section class="bg-white rounded-3xl px-6 md:px-12 lg:px-16 py-16 md:py-20">
            <div class="mb-10 md:mb-14 max-w-3xl">
                ...
                <h2 class="font-degular font-bold text-drygray-100 mt-4 text-h2 md:text-[40px] md:leading-[1.05]">
                    Ingest · Transcribe · Structure · Cite<span class="text-primary-text">.</span>
                </h2>
            </div>
        ...
        <section class="bg-white rounded-3xl px-6 md:px-12 lg:px-16 py-16 md:py-20">
            ...
            <h2 class="font-degular font-bold text-drygray-100 mt-4 text-h2 md:text-[40px] md:leading-[1.05]">
                Where audio analysis earns its keep<span class="text-primary-text">.</span>
            </h2>
            ...
            <div class="grid lg:grid-cols-12 gap-8 items-end">
                <div class="lg:col-span-8">
                    ...
                    <h2 class="font-degular font-bold text-drygray-100 mt-4 text-[40px] leading-[1.05] md:text-[56px] md:leading-[1.02] tracking-tight">
                        Conversations at the scale of archives<span class="text-primary-text">.</span>
                    </h2>
                </div>
