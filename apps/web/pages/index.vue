        ...
        <section class="bg-white rounded-3xl px-6 md:px-12 lg:px-16 py-16 md:py-20">
            <div class="grid lg:grid-cols-12 gap-10 items-center">
                ...
                <div class="lg:col-span-5">
                    <!-- AlpOS console preview — fake product window showing ontology investigation -->
                    <div class="bg-white rounded-2xl overflow-hidden shadow-xl ring-1 ring-drygray-200">
                        ...
                        <div class="bg-white px-5 py-4">
                            <div class="flex items-center justify-between text-[10px] font-mono uppercase tracking-[0.15em] text-drygray-default mb-3">
                                <span>Ontology · Investigation</span>
                                <span>14 entities · 9 events</span>
                            </div>
                            <svg viewBox="0 0 380 220" class="w-full h-auto" role="img" aria-label="AlpOS ontology graph snapshot: flagged entity linked to a transaction across two companies and an account.">
                                <defs>
                                    <pattern id="alpos-grid" width="20" height="20" patternUnits="userSpaceOnUse">
                                        <path d="M 20 0 L 0 0 0 20" fill="none" stroke="rgba(0,0,0,0.04)" stroke-width="1" />
                                    </pattern>
                                </defs>
                                <rect width="380" height="220" fill="url(#alpos-grid)" />
                                ...
                                <!-- Animated active edge: TX -> flagged Person -->
                                ...
                                <!-- Pulse halo around flagged Person -->
                            ...
                            <div class="border-t border-drygray-200 mt-3 pt-3 flex items-start gap-2.5">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <p class="text-[9px] font-mono text-drygray-default uppercase tracking-[0.15em] mt-1">
                                        13:42:08 · analyst@ministry · conf 0.92
                                    </p>
                                </div>
                            </div>
                        </div>
